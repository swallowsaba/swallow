...
const ENTRIES: readonly Concept[] = [
  ...
  { term: 'force-with-lease', plain: '「自分が最後に見たときから相手が変わっていなければ」だけ上書きする push の付け足し。人の仕事をうっかり消さないための安全装置。' },
  { term: 'gitlink', plain: '別のリポジトリの「このコミット」という1点だけを記録した印。中身のファイルは持たない。submodule の正体。' },
  { term: 'fsck', plain: 'リポジトリの中身が壊れていないか、どこからも辿れないものが無いかを調べる git のコマンド。' },
  ...
  { term: 'reset', plain: 'ブランチの札を別のコミットへ付け替えること。--hard を付けると作業ツリーもその時点に戻る。', aliases: ['リセット'] },
  ...
  { term: 'ノード', plain: 'Kubernetes がまとめて使うコンピュータの1台1台。アプリはノードの上で動く。' },
  ...
  { term: 'tick', plain: 'この練習場の時間の刻み。1 tick は 1 秒ぶん。kubectl wait 10 で 10 tick 進む。' },
  ...
  { term: 'allocatable', plain: 'ノードが Pod に貸し出せる量。そのコンピュータの全部から、Kubernetes 自身が使う分を引いた残り。' },
  { term: 'limits', plain: 'Pod が「これ以上は使わない」という上限。超えると止められる。' },
  { term: 'probe', plain: 'Pod が元気かどうかを定期的に確かめる検査。readiness（受付を始めてよいか）と liveness（生きているか）がある。', aliases: ['readiness', 'liveness', 'readinessProbe', 'livenessProbe'] },
  ...
  { term: 'ルーティング', plain: '荷物の宛先を見て、次にどこへ渡すかを決めること。この受け渡しを繰り返して相手まで届く。', aliases: ['経路制御'] },
  ...
  { term: '3ウェイハンドシェイク', plain: 'TCP で話し始める前の、SYN → SYN+ACK → ACK の3回のあいさつ。', aliases: ['ハンドシェイク'] },
  ...
  { term: 'DORA', plain: 'DHCP で住所をもらうときの4つのやりとり（Discover 探す → Offer 申し出る → Request 頼む → Ack 決まり）の頭文字。' },
  ...
  { term: 'ClientHello', plain: 'TLS の最初のあいさつ。「使える暗号の種類はこれです」と、つなぎに行く側が送る。' },
  ...
  { term: 'ロードバランサ', plain: '届いた注文を、後ろにいる何台かのサーバへ振り分ける係。', aliases: ['LoadBalancer'] },
  { term: 'ヘルスチェック', plain: '振り分け先のサーバが元気かを定期的に確かめること。落ちているサーバには振り分けない。' },
  { term: 'VPC', plain: 'クラウドの中に作る、自分専用のネットワーク。' },
  /* ---------------- ふだんの言葉（説明は要らないが、引けるようにしておく） ---------------- */
  { common: true, term: 'ファイル', plain: '名前を付けて保存した中身のひとかたまり。文章でも絵でもプログラムでもよい。' },
  { common: true, term: 'アプリ', plain: '何かの役に立つプログラムのひとまとまり。Web サイトも、この練習場もアプリ。' },
  { common: true, term: 'メッセージ', plain: '誰かに向けて書いた短い文。コミットに添える一言もこれ。' },
  { common: true, term: 'コピー', plain: '同じ中身をもう1つ作ること。元は残る。' },
  { common: true, term: 'サイズ', plain: '大きさ。ファイルなら何バイトあるか。' },
  { common: true, term: 'コード', plain: '人が書いたプログラムの文字そのもの。' },
  { common: true, term: 'ルール', plain: '決まりごと。' },
  { common: true, term: 'ツリー', plain: '枝分かれして広がる形。ディレクトリの入れ子や歴史の枝分かれを指す。' },
  { common: true, term: 'アドレス', plain: '住所。どこにあるかを指す文字列。' },
  { common: true, term: 'ログイン', plain: '自分だと名乗って中に入ること。' },
  { common: true, term: 'キーボード', plain: '文字を打ち込む板。' },
  { common: true, term: 'テスト', plain: '思ったとおりに動くかを確かめる検査。' },
  { common: true, term: 'テーブル', plain: '行と列で並べた表。' },
  { common: true, term: 'データ', plain: 'コンピュータが扱う中身。数でも文字でも絵でもよい。' },
  { common: true, term: 'キー', plain: '名前と値の組の「名前」の側。鍵の意味でも使う。' },
  { common: true, term: 'マーカ', plain: '目印。ここが境目だと分かるように置く印。' },
  { common: true, term: 'アップロード', plain: '手元のものを、向こう側へ送って置くこと。' },
  { common: true, term: 'コンピュータ', plain: '計算をする機械。' },
  { common: true, term: 'サーバ', plain: '頼まれた仕事をこなして返す側のコンピュータ。' },
  { common: true, term: 'ケーブル', plain: '機械どうしをつなぐ線。' },
  { term: 'ホスト', plain: 'ネットワークにつながっている 1 台のコンピュータ。パソコンもサーバもホスト。' },
  { term: 'トークン', plain: '「たしかにあなたです」と示すための合言葉の文字列。渡すと本人として扱われる。' },
  { term: 'ファイルシステム', plain: 'ファイルをどう並べて保存しておくかの仕組み。' },
  { term: 'テンプレート', plain: '同じ形のものを何個も作るための型。Deployment はこの型から Pod を作る。' },
  { term: 'バッチ', plain: 'まとめて一度に片付ける処理。夜のうちに走らせることが多い。' },
  { term: 'メモリ', plain: 'コンピュータが作業中のものを置いておく場所。電源を切ると消える。' },
  { term: 'CPU', plain: 'コンピュータの計算する部分。ここが足りないと処理が遅くなる。' },
  { term: 'コア', plain: 'CPU の中で実際に計算する単位。数が多いほど同時に多くこなせる。' },
  { common: true, term: 'リンク', plain: 'つながり。ネットワークではケーブル1本ぶんのつながりを指す。' },
  { term: 'インタフェース', plain: 'ネットワークの差し込み口。eth0 のような名前が付く。' },
  { term: 'デプロイ', plain: '作ったものを動く場所に置いて、使えるようにすること。' },
  { term: 'プロビジョニング', plain: '必要なものを、頼まれた時点で自動で用意すること。' },
  { term: 'バックエンド', plain: '表からは見えない側で、実際の処理をしている所。' },
  { term: 'ロック', plain: '同時に触られないよう、使っている間だけ掛ける鍵。' },
  { term: 'デッドロック', plain: '互いに相手の鍵が空くのを待ち続けて、どちらも進めなくなった状態。' },
  { term: 'マージコミット', plain: 'マージしたときにできる、親を 2 つ持つコミット。' },
  { term: 'クローン', plain: 'リモートのリポジトリを、まるごと手元に写し取ること。' },
  { term: 'データベース', plain: 'たくさんのデータを整理してしまっておく入れ物。後から探したり並べ替えたりできる。', aliases: ['DB'] },
  { term: 'API', plain: 'プログラムどうしが話すための、決まった形の窓口。' },
  { term: 'CSV', plain: '値をコンマで区切って1行ずつ並べた、表のファイル。' },
  { term: 'E2E', plain: '人が使うのと同じ道筋で、端から端まで通して試す検査。' },
  { term: 'NodePort', plain: 'どのノードの決まった番号の窓口に来ても、その Service へ届くようにする公開のしかた。' },
  { term: 'NoSchedule', plain: 'taint の効き方の 1 つ。「この札に耐えられない Pod はここに置かない」。' },
  { term: 'OutOfMemory', plain: 'メモリを使い切って、そのプログラムが止められたこと。' },
  { term: 'restartCount', plain: 'そのコンテナが起動し直された回数。増え続けていれば落ち続けている。' },
  { term: 'envFrom', plain: 'ConfigMap や Secret の中身を、まとめて環境変数として渡す書き方。' },
  { term: 'ESTABLISHED', plain: 'TCP で、つながって荷物をやりとりできている状態。' },
  { term: 'CLOSED', plain: 'TCP で、つながっていない状態。' },
  { term: 'SIGINT', plain: 'Ctrl+C で送られる「やめて」という合図（2番）。' },
  { term: 'SIGHUP', plain: '「つながりが切れた」ことを知らせる合図（1番）。設定の読み直しに使われることもある。' },
  { term: 'SIGQUIT', plain: '「やめて、そのときの様子も残して」という合図（3番）。' },
];
